...
(function(factory, undefined) {
    ...
    if ($.fn.mediasorterResize)
        return;

    $.fn.mediasorterResize = function fnResizable(options) {
        var defaultOptions = {
        ...
        return this.each(function () {
            ...
            function doDrag(e) {
                ...
                $(".mediasorter_sidebar_fixed").css("width", $(".mediasorter_sidebar").width() + "px")
            }
            ...
            function update_splitter_width(e){
                ...
                if (opt.resizeWidthFrom === 'left')
                    ...
                    newWidth = startPos.width + pos.x - startPos.x;
                var data = {
                    'action' 	: 	'mediasorterAjaxSaveSplitter',
