...
(function($){
	...
	media.view.AttachmentFilters.Taxonomy = media.view.AttachmentFilters.extend({	
		...
		createFilters: function() {
			...
			_.each(mediasorter_taxonomies.folder.term_list || {}, function( term, key ) {
				...
				filters[term_id]['props'][mediasorter_folder] = term_id;
			});
			
			filters.all = {
				text: mediasorter_taxonomies.folder.list_title,
				priority: 1
			};
			filters['all']['props'] = {};
			filters['all']['props'][mediasorter_folder] = null;
